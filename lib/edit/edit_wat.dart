...
import 'package:flutter_travel/add/add_wat.dart';

import 'package:flutter_travel/models/model_travel.dart';

class EditWatPage extends StatefulWidget {
  @override
  _EditWatPageState createState() => _EditWatPageState();
}

class _EditWatPageState extends State<EditWatPage> {
  GlobalKey<ScaffoldState> scaffoldKey = GlobalKey();

  final watRef = FirebaseDatabase.instance.reference().child('wat');
  List<Travel> items;
  ...
  void _navigateToWat(BuildContext context, Travel travel) async {
    await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => AddWatPage(travel)),
    );
  }
}
